...
1. At the step the platform creates a scheduled job that initiates Subscription processing periodically. It reads active Subscriptions from database and generates new Orders (if needed).
