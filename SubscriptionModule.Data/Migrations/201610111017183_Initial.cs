namespace SubscriptionModule.Data.Migrations
{
    using System;
    ...
    public partial class Initial : DbMigration
    {
        ...
        {
            CreateTable(
                "dbo.SubscriptionOrderRelation",
                c => new
                    {
                        Id = c.String(nullable: false, maxLength: 128),
                        CustomerOrderId = c.String(maxLength: 64),
        ...
        {
            DropForeignKey("dbo.SubscriptionOrderRelation", "SubscriptionId", "dbo.Subscription");
            DropIndex("dbo.SubscriptionOrderRelation", new[] { "SubscriptionId" });
            DropTable("dbo.PaymentPlan");
            DropTable("dbo.Subscription");
            DropTable("dbo.SubscriptionOrderRelation");
        }
    }
}
